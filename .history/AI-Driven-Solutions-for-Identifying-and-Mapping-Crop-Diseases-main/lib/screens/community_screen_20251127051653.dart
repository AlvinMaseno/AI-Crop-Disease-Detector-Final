...
import 'comments_screen.dart'; // --- 1. IMPORT ADDED ---
...
class ForumPost {
  ...
  factory ForumPost.fromFirestore(DocumentSnapshot doc) {
    ...
    return ForumPost(
      ...
      comments: data['comments'] ?? 0, // Now this will update automatically!
    );
  }
}
                    ...
                    Row(
                      children: [
                        CircleAvatar(
                          ...
                          child: Text(post.userAvatar, style: TextStyle(color: theme.primaryColor, fontWeight: FontWeight.bold)),
                        ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _buildActionButton(
                          ...
                          color: Colors.grey,
                          // --- 2. NAVIGATION TO COMMENTS SCREEN ---
                          onTap: () {
                             Navigator.push(
                               context,
                               MaterialPageRoute(
