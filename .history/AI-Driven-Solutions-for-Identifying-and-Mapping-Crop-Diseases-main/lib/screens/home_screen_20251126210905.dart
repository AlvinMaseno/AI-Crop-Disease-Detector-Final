...
import '../widgets/card_widget.dart'; // Assuming your NavigationCard and CustomCard are here
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // Recent Reports List (Connected to Provider)
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return DiseaseReportCard(
                      ...
                      // CRITICAL UPDATE: Using formattedConfidence (String) instead of double
                      confidence: report.formattedConfidence, 
                      severity: report.severity,
                      date: report.detectedAt,
                      onTap: () {
                         // Simple snackbar for now
                         ScaffoldMessenger.of(context).showSnackBar(
                           SnackBar(content: Text('Treatment: ${report.treatmentRecommendation.substring(0, 30)}...')),
                         );
                      },
                    );
                  },
