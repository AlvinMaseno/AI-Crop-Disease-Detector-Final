        ...
        content: Column(
          ...
          children: [
            ...
            CustomTextField(
              ...
              obscureText: true,
              // Fixed: Changed invalid Icon(Icons.lock_check) to Icon(Icons.lock)
          ...
          ElevatedButton(
            onPressed: () {
              if (newPassCtrl.text.isNotEmpty && 
                ...
                // In a real app, you would update the password in the provider here
                      ...
                      child: _isEditing 
                        ...
                        : Column(
                            ...
                            children: [
                              ...
                              Chip(
                                label: Text(user?.role.toString().split('.').last.toUpperCase() ?? "FARMER"),
