...
// Ensure this path points to where your DiseaseReportCard and CustomButton are defined
...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  // Filter logic updated for the new model
  List<DiseaseReport> _getFilteredReports() {
    ...
    // Filter by search query (Disease Name or Crop Name)
  ...
  void _handleDownloadReports() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Downloading complete report as PDF...'),
        duration: Duration(seconds: 2),
      ),
    );
    // Future implementation: Use 'pdf' and 'printing' packages here
  }
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return DiseaseReportCard(
                          ...
                          // Use the getter from the model for the string format "98.5%"
