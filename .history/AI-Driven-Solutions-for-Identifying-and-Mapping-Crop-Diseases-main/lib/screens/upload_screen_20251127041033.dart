...
/// --- NEW LOGIC: CALCULATE SEVERITY BASED ON DISEASE TYPE ---
String getSeverity(String rawDiseaseName) {
  ...
  // Examples: Leaf Miner, Leaf Spot (sometimes), Grasshopper damage
  ...
  // 3. Critical diseases are High
  // Examples: Mosaic Virus, Blight, Rot, Wilt, Armyworm
  return 'High';
}

/// Provides treatment suggestions based on the specific diseases.
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data.containsKey("prediction") && data.containsKey("confidence")) {
          ...
          // 3. Calculate Severity (NEW LOGIC)
          ...
          final newReport = DiseaseReport(
            ...
            severity: severity, // Using the logic based on disease type
